 ...
 * <h2>Main Classes</h2>
 * <ul>
 *   <li>{@link eu.mrneznamy.slimefuncontinued.entities.holograms.HologramManager} - Main API for creating and managing holograms</li>
 *   <li>{@link eu.mrneznamy.slimefuncontinued.entities.holograms.EntityHologram} - Represents a single hologram entity</li>
 *   <li>{@link eu.mrneznamy.slimefuncontinued.entities.holograms.EntityHologramService} - Internal service for hologram management</li>
 *   <li>{@link eu.mrneznamy.slimefuncontinued.entities.holograms.HologramExample} - Usage examples and best practices</li>
 * </ul>
 * 
 * <h2>Quick Start</h2>
 * <pre>{@code
 ...
 * EntityHologram hologram = HologramManager.createHologram(this, loc, "Â§6Hello World!");
 * 
 * // Update the hologram
 * HologramManager.updateHologramText(this, loc, "Â§aUpdated Text!");
 * 
 * // Remove the hologram
