...
public class HologramIntegrationTest {
    ...
    public void testPackageStructure() {
        ...
        assertEquals("eu.mrneznamy.slimefun5.entities.holograms", EntityHologram.class.getPackageName());
        assertEquals("eu.mrneznamy.slimefun5.entities.holograms", EntityHologramService.class.getPackageName());
        assertEquals("eu.mrneznamy.slimefun5.entities.holograms", HologramManager.class.getPackageName());
    }
    ...
    public void testStaticMethods() {
        ...
        assertDoesNotThrow(() -> {
            ...
            EntityHologram.class.getMethod("hasHologramData", 
                ...
                eu.mrneznamy.slimefun5.blocks.BlockPosition.class,
